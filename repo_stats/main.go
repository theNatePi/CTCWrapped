...
func main() {
	...
	stats := utils.NewStats(repoUser, repoName,
		[]string{".png", ".svg", ".jpg", ".lock", ".json", ".log", ".md", ".yml", ".pdf"},
		[]string{"package-lock.json", "yarn.lock", "package.json"},
		[]string{".github", ".git", ".husky", "client/docs", "client/node_modules", "client/patches",
			"server/node_modules"},
	)
